...
//! - Cookies
//!
//! The [`reqwest_impersonate::Client`][client] is asynchronous. For applications wishing
//! to only make a few HTTP requests, the [`reqwest_impersonate::blocking`](blocking) API
